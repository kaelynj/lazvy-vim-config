...
wk.register({
  ["<leader>n"] = {
    ...
    w = {
      name = "+workspace",
      h = { "<cmd>Neorg workspace homelab<cr>", "Open homelab workspace" },
      e = { "<cmd>Neorg workspace gmeclipse<cr>", "Open Eclipse Phase workspace" },
      g = { "<cmd>Neorg workspace oldGods<cr>", "Open Old Gods of Appalachia workspace" },
    },
    j = {
      name = "+journal",
